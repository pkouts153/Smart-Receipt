 ...
 * 
 * this AsyncTask is used to retrieve Family records from the server database.
 *  These records will be after the maximum id stored in this table 
 *
 */

public class RetrieveFamilyAfterIdTask extends AsyncTask<SQLiteDatabase, Void, Void> {
	...
	protected Void doInBackground(SQLiteDatabase... arg0) {
    	...
    	String URL = "http://10.0.2.2/php/rest/family.php";//the web service URL
		...
		//call fetchFamilyMaxId method to get the maximum saved id and add this id to the URL
        ...
        if(entity!=null){
			try{
        		...
        		//call handleFamilyJSONArrayForRetrieve method
