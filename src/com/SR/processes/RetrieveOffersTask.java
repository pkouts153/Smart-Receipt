...
public class RetrieveOffersTask extends AsyncTask<SQLiteDatabase, Void, String> {
    ...
    @Override
 	protected String doInBackground(SQLiteDatabase... arg0) {
    	...
    	String result; 
    	String URL = "http://10.0.2.2/php/rest/offer.php";
    	HttpEntity entity;
        ...
        if(entity!=null){
			try{
                ...
                Log.i("RetrieveOffer", jsonArray.toString());
